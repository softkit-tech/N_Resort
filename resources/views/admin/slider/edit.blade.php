...
@section('admin_content')
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Edit Lecture Section</span>
      </nav>
      <div class="sl-pagebody">
      	   <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Edit Lecture Add <a href="{{route('all.slider')}}" class="btn btn-success btn-sm pull-right">All Lecture</a></h6>
          <p class="mg-b-20 mg-sm-b-30">Edit Lecture add form</p>
            ...
            <div class="row mg-b-25">
               ...
               <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label"> Type Title: <span class="tx-danger">*</span></label>
              ...
              <div class="col-lg-4">
              	...
              	<label class="custom-file">
      		     ...
      		     <img src="#" id="one" >
      				  	...
      				  	<img id="logo" src="{{asset('public/backend/media/slider/'.$edit_data->image) }}" width="50" height="50;" />
              </div>
