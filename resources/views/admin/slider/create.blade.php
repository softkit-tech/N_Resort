...
@section('admin_content')
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <h6 class="card-body-title">New Slider Add <a href="{{route('all.slider')}}" class="btn btn-success btn-sm pull-right">All Slider</a></h6>
            ...
            <div class="row mg-b-25">
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="title" placeholder="Slider Title" required=""  >
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
