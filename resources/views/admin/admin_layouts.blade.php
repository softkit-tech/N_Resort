...
<html lang="en">
 ...
 @guest
     ...
     @else
        <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{ url('/home') }}"><i class="icon ion-android-star-outline"></i> Admin</a></div>
    <div class="sl-sideleft">
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('report.list')}}" class="nav-link">Booking List</a></li>
          <li class="nav-item"><a href="" class="nav-link">Peding Booking</a></li>
        </ul>
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
            <span class="menu-item-label">Room </span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('add.hotal')}}" class="nav-link">Add Room</a></li>
          <li class="nav-item"><a href="{{route('all.hotal')}}" class="nav-link">All Room</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('add.slider')}}" class="nav-link">Add Slider</a></li>
          <li class="nav-item"><a href="{{route('add.slider')}}" class="nav-link">All Slider</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('add.logo')}}" class="nav-link">Add Logo</a></li>
          <li class="nav-item"><a href="{{route('all.logo')}}" class="nav-link">All Logo</a></li>
        </ul>
                <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('add.social')}}" class="nav-link">Add Social</a></li>
          <li class="nav-item"><a href="{{route('add.social')}}" class="nav-link">All Social</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('add.postcategory')}}" class="nav-link">Add Post Category</a></li>
          <li class="nav-item"><a href="{{route('all.postcategory')}}" class="nav-link">All Post Category</a></li>
        </ul>
