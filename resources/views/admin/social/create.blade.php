            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="icon" required="" placeholder="Social Icon" >
                </div>
              </div><!-- col-4 -->
               ...
               <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="link" required="" placeholder="Social Link" >
                </div>
              </div><!-- col-4 -->
